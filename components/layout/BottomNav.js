...
export default function BottomNav() {
    ...
    return (
        <nav className="fixed bottom-6 left-5 right-5 h-[72px] bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl border border-white/20 dark:border-white/10 flex justify-around items-center z-50 mx-auto max-w-[560px] rounded-[32px] shadow-2xl shadow-black/20">
            <Link
                href="/dashboard"
