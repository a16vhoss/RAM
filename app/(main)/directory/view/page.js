    ...
    useEffect(() => {
        async function fetchProvider() {
            ...
            try {
                ...
                const res = await fetch(`${API_BASE}/api/rpc/directory`, {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
                    body: JSON.stringify({ action: 'getProvider', data: { id: providerId } })
                });
        ...
        return (
            <div className="min-h-screen bg-background-dark flex items-center justify-center text-white">
                <div className="text-center">
                    ...
                    <Link href="/directory" className="text-primary hover:underline">Volver al directorio</Link>
                </div>
            </div>
        );
    }
